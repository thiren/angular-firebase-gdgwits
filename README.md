# angular-firebase-gdgwits [![Build Status](https://travis-ci.org/thiren/angular-firebase-gdgwits.svg?branch=master)](https://travis-ci.org/thiren/angular-firebase-gdgwits)
